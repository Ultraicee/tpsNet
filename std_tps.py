...
if params.model=='TPS':
    ...
    print("load T matrix from {}".format(os.path.join(params.output_directory, 'tps_trained_.npy')))
    T_init = np.load(os.path.join(params.output_directory, 'tps_trained_.npy'))
...
with tf.Graph().as_default():
    ...
    loss_rec, compa_sum, loss_rec_sum = compute_rec_loss(right_est, right, compensateI, params, 160.0)
